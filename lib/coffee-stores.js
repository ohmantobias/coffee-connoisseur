...
const getUrlforCoffeeStores = (latLong, limit) => {
  return `https://api.foursquare.com/v3/places/nearby?ll=${latLong}&query=coffee stores&v=20220105&limit=${limit}`;
};
...
export const fetchCoffeeStores = async (
  ...
  const response = await fetch(getUrlforCoffeeStores(latLong, limit), options);
